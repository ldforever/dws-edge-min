...
import { $, cell, clear, el, gb, imageCell, positionLabel, dash } from "./dom.js?v=91099a1e";
import { alertLabel, fmtAge, fmtRate } from "./monitor.js?v=91099a1e";
const MAX_ROWS = 120;
 ...
 */
async function softTriggerOnce() {
    const button = $("btnSoftTrigger");
