 ...
 */
import { $ } from "./dom.js";
import type { DeviceView, MonitorSummary } from "./types.js";

const ALERT_LIMIT = 99;

function set(node: HTMLElement, count: number, kind: "alert" | "info", title: string): void {
...
export function renderNavBadges(devices: DeviceView | null, monitor: MonitorSummary | null): void {
